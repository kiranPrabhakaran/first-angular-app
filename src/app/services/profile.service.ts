...
export class ProfileService {
  ...
  getResposFile(){
    return this.profileService.get<any>('https://api.github.com/users/'+ this.username + "/repos/"+ this.repos +"/commits{/sha}?client_id=" + this.clientid + "&client_secret=" + this.clientsecret);
  }
//https://api.github.com/repos/swds/cms/commits{/sha}
  updateProfile(username:string){
  	this.username = username;
  }
  updateRespo(respos:string){
    this.repos = respos;
  }
